package com.work.jsy.jiaobao2.circledemo.adapter;
...
import com.work.jsy.jiaobao2.circledemo.adapter.viewholder.URLViewHolder;
import com.work.jsy.jiaobao2.circledemo.adapter.viewholder.VideoViewHolder;
import com.work.jsy.jiaobao2.circledemo.bean.ActionItem;
...
import com.work.jsy.jiaobao2.circledemo.utils.DatasUtil;
import com.work.jsy.jiaobao2.circledemo.utils.GlideCircleTransform;
import com.work.jsy.jiaobao2.circledemo.utils.UrlUtils;
...
import com.work.jsy.jiaobao2.circledemo.widgets.PraiseListView;
import com.work.jsy.jiaobao2.circledemo.widgets.SnsPopupWindow;
import com.work.jsy.jiaobao2.circledemo.widgets.dialog.CommentDialog;
...
public class CircleAdapter extends BaseRecycleViewAdapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(viewType == TYPE_HEAD){
            View headView = LayoutInflater.from(parent.getContext()).inflate(R.layout.friend_head_circle, parent, false);
            viewHolder = new HeaderViewHolder(headView);
        }else{
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.friend_adapter_circle_item, parent, false);
