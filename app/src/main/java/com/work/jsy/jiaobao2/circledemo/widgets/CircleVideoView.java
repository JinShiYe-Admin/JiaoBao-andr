package com.work.jsy.jiaobao2.circledemo.widgets;
...
import com.work.jsy.jiaobao2.circledemo.widgets.videolist.VideoListGlideModule;
import com.work.jsy.jiaobao2.circledemo.widgets.videolist.model.VideoLoadMvpView;
import com.work.jsy.jiaobao2.circledemo.widgets.videolist.target.VideoLoadTarget;
import com.work.jsy.jiaobao2.circledemo.widgets.videolist.target.VideoProgressTarget;
import com.work.jsy.jiaobao2.circledemo.widgets.videolist.visibility.items.ListItem;
...
public class CircleVideoView extends LinearLayout implements VideoLoadMvpView, ListItem {
    ...
    private void init() {
        inflate(getContext(), R.layout.friend_layout_video, this);
