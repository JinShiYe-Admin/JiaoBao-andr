...
import com.work.jsy.jiaobao2.circledemo.utils.DensityUtil;
...
public class SnsPopupWindow extends PopupWindow implements OnClickListener{
	...
	public SnsPopupWindow(Context context) {
		View view = LayoutInflater.from(context).inflate(R.layout.friend_social_sns_popupwindow, null);
		...
		this.setWidth(DensityUtil.dip2px(context, 120));
		this.setHeight(DensityUtil.dip2px(context, 50));
